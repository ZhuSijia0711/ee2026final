...
HD_PWD='C:/Users/86131/Downloads/EE2026/integrated_project v3.0.xpr/integrated_project/integrated_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log click_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source click_display.tcl
