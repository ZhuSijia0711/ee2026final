...
HD_PWD='C:/Users/86131/Downloads/EE2026/integrated_project v3.0.xpr/integrated_project/integrated_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log click_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source click_display.tcl -notrace
